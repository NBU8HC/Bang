...
try:
    from add_new_parameter import ParameterAdditionTool
except ImportError:
    ParameterAdditionTool = None
try:
    from split_parameter import main as split_parameter_main
except ImportError:
    split_parameter_main = None
try:
    from dcm_parameter_tool import main as update_parameter_main
except ImportError:
