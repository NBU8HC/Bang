...
class ParameterClonerApp:
    ...
    def setup_gui(self):
        ...
        list_section = tk.LabelFrame(main_frame, text="📄 Parameter List File", 
                                    ...
                                    relief=tk.FLAT, 
                                    borderwidth=2)
        list_section.grid(row=0, column=0, columnspan=3, sticky='ew', pady=(0, 15), padx=2)
        ...
        files_section = tk.LabelFrame(main_frame, text="📂 Parameter Files Selection", 
                                     ...
                                     relief=tk.FLAT, 
                                     borderwidth=2)
        files_section.grid(row=1, column=0, columnspan=3, sticky='ew', pady=(0, 15), padx=2)
        ...
        btn_style = {'font': ('Segoe UI', 9), 'relief': tk.FLAT, 'cursor': 'hand2', 'width': 20, 'pady': 8}
        ...
        scan_single_btn.pack(pady=(0, 8))
        
        scan_multi_btn = tk.Button(file_buttons_frame, text="🔍 Scan Multiple Dirs", 
                                  command=self.scan_multiple_directories,
                                  bg=self.colors['secondary'], fg='white', **btn_style)
        scan_multi_btn.pack(pady=(0, 8))
        
        remove_btn = tk.Button(file_buttons_frame, text="🗑️ Remove Selected", 
        ...
        suffix_frame = tk.LabelFrame(main_frame, text="⚙ Suffix Configuration", 
                                    ...
                                    relief=tk.FLAT, 
                                    borderwidth=2)
        suffix_frame.grid(row=2, column=0, columnspan=3, sticky='ew', pady=(0, 15), padx=2)
        ...
        cloning_frame = tk.LabelFrame(main_frame, text="🔧 Cloning Options", 
                                     ...
                                     relief=tk.FLAT, 
                                     borderwidth=2)
        cloning_frame.grid(row=3, column=0, columnspan=3, sticky='ew', pady=(0, 15), padx=2)
        ...
        action_btn_style = {'font': ('Segoe UI', 10, 'bold'), 'relief': tk.FLAT, 'cursor': 'hand2', 'pady': 12, 'padx': 20}
        
        load_btn = tk.Button(button_frame, text="1️⃣ Load Files", command=self.load_files, 
                            bg=self.colors['primary'], fg='white', width=18, **action_btn_style)
        load_btn.pack(side=tk.LEFT, padx=(0, 10))
        
        update_btn = tk.Button(button_frame, text="2️⃣ Update Suffix Array", command=self.update_suffix_array, 
                              bg=self.colors['warning'], fg='white', width=20, **action_btn_style)
        update_btn.pack(side=tk.LEFT, padx=(0, 10))
        
        clone_btn = tk.Button(button_frame, text="3️⃣ Clone Parameters", command=self.clone_parameters, 
                             bg=self.colors['success'], fg='white', width=20, **action_btn_style)
        ...
        self.param_config_frame = tk.LabelFrame(main_frame, text="📋 Parameter Configuration", 
                                               ...
                                               relief=tk.FLAT, 
                                               borderwidth=2)
        self.param_config_frame.grid(row=5, column=0, columnspan=3, sticky='ew', pady=(15, 0), padx=2)
