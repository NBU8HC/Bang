...
Invoke-Expression "$python -m PyInstaller --onefile --windowed --name add_new_parameter add_new_parameter.py"
Set-Location ..
...
Invoke-Expression "$python -m PyInstaller --onefile --windowed --name split_parameter split_parameter.py"
Set-Location ..
